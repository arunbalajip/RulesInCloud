  ...
  for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
    ...
    do {
      ...
      var c = 0 == n[1].length ? 0 : parseInt(n[1], 10),
        m = 0 == q[1].length ? 0 : parseInt(q[1], 10),
        c = goog.string.compareElements_(c, m) || goog.string.compareElements_(0 ==
...
Blockly.Field.prototype.onMouseUp_ = function(a) {
  if (!goog.userAgent.IPHONE && !goog.userAgent.IPAD || 0 === a.layerX || 0 === a.layerY) Blockly.isRightButton(a) || 2 != Blockly.dragMode_ && this.sourceBlock_.isEditable() && this.showEditor_()
};
...
goog.getObjectByName("document.documentElement.ontouchstart") && (Blockly.Scrollbar.scrollbarThickness = 25);
...
Blockly.Xml.domToBlock = function(a, b, c) {
  ...
  a.rendered && ((a = d.getNextBlock()) ? a.render() : d.render());
  return d
};
...
Blockly.WorkspaceSvg.prototype.fireChangeEvent = function() {
  if (this.rendered) {
    this.fireChangeEventPid_ && clearTimeout(this.fireChangeEventPid_);
    var a = this.svgBlockCanvas_;
    a && (this.fireChangeEventPid_ = setTimeout(function() {
...
Blockly.BlockSvg.prototype.setDisabled = function(a) {
  this.disabled != a && (Blockly.BlockSvg.superClass_.setDisabled.call(this, a), this.updateDisabled(), this.workspace.fireChangeEvent())
};
...
Blockly.BlockSvg.prototype.render = function() {
  ...
  Blockly.RTL && (a = -a);
  for (var b = this.getIcons(), c = 0; c < b.length; c++) a = b[c].renderIcon(a);
  a += Blockly.RTL ? Blockly.BlockSvg.SEP_SPACE_X : -Blockly.BlockSvg.SEP_SPACE_X;
  b = this.renderCompute_(a);
  this.renderDraw_(a, b);
  (a = this.getParent()) ? a.render(): Blockly.fireUiEvent(window, "resize");
  Blockly.Realtime.blockChanged(this)
};
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
  ...
  for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.inputsInline && !this.isCollapsed(), p = 0, n; n = b[p]; p++)
    if (n.isVisible()) {
      var q;
      l && k && k != Blockly.NEXT_STATEMENT && n.type != Blockly.NEXT_STATEMENT ? q = c[c.length - 1] : (k = n.type, q = [], q.type = l && n.type != Blockly.NEXT_STATEMENT ?
        Blockly.BlockSvg.INLINE : n.type, q.height = 0, c.push(q));
      q.push(n);
      ...
      if (n.connection && n.connection.targetConnection) {
        var m = n.connection.targetBlock().getHeightWidth();
        n.renderHeight = Math.max(n.renderHeight, m.height);
        n.renderWidth = Math.max(n.renderWidth, m.width)
      }
      p == b.length - 1 && n.renderHeight--;
      q.height = Math.max(q.height, n.renderHeight);
      n.fieldWidth = 0;
      1 ==
        c.length && (n.fieldWidth += Blockly.RTL ? -a : a);
      for (var m = !1, r = 0, t; t = n.fieldRow[r]; r++) {
        0 != r && (n.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X);
        var u = t.getSize();
        t.renderWidth = u.width;
        t.renderSep = m && t.EDITABLE ? Blockly.BlockSvg.SEP_SPACE_X : 0;
        n.fieldWidth += t.renderWidth + t.renderSep;
        q.height = Math.max(q.height, u.height);
        m = t.EDITABLE
      }
      q.type != Blockly.BlockSvg.INLINE && (q.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, n.fieldWidth)) : (q.type == Blockly.INPUT_VALUE ? f = !0 : q.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d,
        n.fieldWidth)))
    } for (a = 0; q = c[a]; a++)
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f, g) {
  for (var h, k = 0, l, p, n = 0, q; q = f[n]; n++) {
    ...
    if (this.isCollapsed()) {
      ...
      for (var r = 0; m = q[r]; r++) l = k + Blockly.BlockSvg.FIELD_HEIGHT, q.thicker && (l += Blockly.BlockSvg.INLINE_PADDING_Y), h = this.renderFields_(m.fieldRow, h, l), m.type != Blockly.DUMMY_INPUT && (h += m.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), m.type == Blockly.INPUT_VALUE && (c.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y)), c.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - m.renderWidth), c.push(Blockly.BlockSvg.TAB_PATH_DOWN),
        c.push("v", m.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT), c.push("h", m.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH), c.push("z"), Blockly.RTL ? (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X - 3 + Blockly.BlockSvg.TAB_WIDTH - m.renderWidth + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y + 1)), d.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), d.push("v", m.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 3), d.push("h", m.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 1)) : (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + 1 + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y +
          ...
          p), m.connection.targetConnection && m.connection.tighten_());
    ...
    } else q.type == Blockly.INPUT_VALUE ? (m = q[0], l = k + Blockly.BlockSvg.FIELD_HEIGHT, m.align != Blockly.ALIGN_LEFT && (r = f.rightEdge - m.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, m.align == Blockly.ALIGN_RIGHT ? h += r : m.align == Blockly.ALIGN_CENTRE && (h += (r + h) / 2)), this.renderFields_(m.fieldRow,
      ...
      a.push("H", f.rightEdge), Blockly.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), b.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL), b.push("H", f.rightEdge - 1)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + q.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),
        b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR), b.push("H", f.rightEdge)), l = e.x + (Blockly.RTL ? -h : h), p = e.y + k + 1, m.connection.moveTo(l, p), m.connection.targetConnection && (m.connection.tighten_(), this.width = Math.max(this.width, f.statementEdge + m.connection.targetBlock().getHeightWidth().width)), n == f.length - 1 || f[n + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y);
    k += q.height
  }
  f.length ||
...
Blockly.Variables.renameVariable = function(a, b, c) {
  c = (c || Blockly.mainWorkspace).getAllBlocks();
...
Blockly.Variables.flyoutCategory = function(a, b, c, d) {
  ...
  for (var f = void 0, g = 0; g < e.length; g++)
    if (e[g] !== f) {
      ...
      h && h.initSvg();
      null === e[g] ? f = (h).getVars()[0] : (h && h.setFieldValue(e[g], "VAR"));
      h && a.push(h);
      h ? b.push(c, 3 * c) : b.push(2 * c)
    }
};
...
Blockly.Procedures.flyoutCategory = function(a, b, c, d) {
  function e(e, f) {
    for (var k = 0; k < e.length; k++) {
      ...
      for (var p = [], n = 0; n < e[k][1].length; n++) p[n] = "ARG" + n;
  ...
  Blockly.readOnly ||
    (Blockly.hasCategories ? Blockly.mainWorkspace.toolbox_ = new Blockly.Toolbox(b, a) : (Blockly.mainWorkspace.flyout_ = new Blockly.Flyout, c = Blockly.mainWorkspace.flyout_, d = c.createDom(), c.autoClose = !1, goog.dom.insertSiblingBefore(d, Blockly.mainWorkspace.svgGroup_)), Blockly.hasScrollbars || Blockly.addChangeListener(function() {
      if (0 == Blockly.dragMode_) {
        ...
        if (a.contentTop < c || a.contentTop + a.contentHeight > a.viewHeight + c ||
          a.contentLeft < (Blockly.RTL ? a.viewLeft : b) || a.contentLeft + a.contentWidth > (Blockly.RTL ? a.viewWidth : a.viewWidth + b))
          for (var d = Blockly.mainWorkspace.getTopBlocks(!1), e = 0, p; p = d[e]; e++) {
            var n = p.getRelativeToSurfaceXY(),
              q = p.getHeightWidth(),
              m = c + 25 - q.height - n.y;
            0 < m && p.moveBy(0, m);
            m = c + a.viewHeight - 25 - n.y;
            0 > m && p.moveBy(0, m);
            m = 25 + b - n.x - (Blockly.RTL ? 0 : q.width);
            0 < m && p.moveBy(m, 0);
            m = b + a.viewWidth - 25 - n.x + (Blockly.RTL ? q.width : 0);
            0 > m && p.moveBy(m, 0)
          }
      }
    }));
...
goog.getObjectByName("document.documentElement.ontouchstart") && (Blockly.bindEvent_.TOUCH_MAP = {
